    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-xl bg-mint px-5 py-2.5 text-sm font-semibold text-mint-foreground"
          >
            Back home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Klarn — Crystal-clear voice meetings with live captions" },
      {
        name: "description",
        content:
          "Free voice meetings with noise cancellation, live captions, host controls, recording, and AI-generated notes. Join with a link.",
      },
      { property: "og:title", content: "Klarn — Crystal-clear voice meetings" },
      {
        property: "og:description",
        content:
          "Voice-first meetings with noise cancellation, live captions, recording, and AI notes.",
      },
